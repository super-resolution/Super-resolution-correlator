...
"")
        ...
        self.push_buttom_correlate.setEnabled(False)
...
"}")
        ...
        self.verticalLayoutWidget = QtWidgets.QWidget(self.Overlay)
        ...
        self.tabWidget.addTab(self.Overlay, "")
    ...
    def retranslateUi(self, Dialog_Roi):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.Overlay), _translate("Dialog_Roi", "Overlay"))
