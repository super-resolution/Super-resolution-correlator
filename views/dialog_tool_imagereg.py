...
# Form implementation generated from reading ui file 'gui\MarkerDialogV6.ui'
#
...
"}")
        ...
        self.verticalLayout_5.addWidget(self.label_10, QtCore.Qt.AlignVCenter)
...
"}")
        ...
        self.verticalLayout_4.addWidget(self.label_6, QtCore.Qt.AlignVCenter)
...
"")
    ...
    def retranslateUi(self, Dialog_Imagereg):
        Dialog_Imagereg.setWindowTitle(_translate("Dialog_Imagereg", "Dialog", None))
        self.label.setText(_translate("Dialog_Imagereg", "<html><head/><body><p align=\"center\"><span style=\" font-size:16pt; font-weight:600; color:#ffaa00;\">Image registration</span></p></body></html>", None))
        self.fijiPathLabel.setText(_translate("Dialog_Imagereg", "FijiPath", None))
        self.landmark_file.setText(_translate("Dialog_Imagereg", "LandmarkPath", None))
        self.open_landmark_file.setText(_translate("Dialog_Imagereg", "Open", None))
        self.label_10.setWhatsThis(_translate("Dialog_Imagereg", "<html><head/><body><p align=\"center\"><span style=\" font-weight:600; color:#aa0000;\">dSTORM configuration:</span></p></body></html>", None))
        self.label_10.setText(_translate("Dialog_Imagereg", "<html><head/><body><p align=\"center\"><span style=\" font-weight:600; color:#ffaa00;\">dSTORM configuration:</span></p><p align=\"center\"><span style=\" font-size:6pt; font-weight:600; color:#ffffff;\">Double click left mouse button</span></p><p align=\"center\"><span style=\" font-size:6pt; font-weight:600; color:#ffffff;\">Change position with control + right click and dragging or by changing values and set</span></p></body></html>", None))
        self.pushButton_delete_STORM.setText(_translate("Dialog_Imagereg", "Delete", None))
        self.label_11.setText(_translate("Dialog_Imagereg", "position X", None))
        self.label_12.setText(_translate("Dialog_Imagereg", "marker number", None))
        self.label_13.setText(_translate("Dialog_Imagereg", "position Y", None))
        self.pushButton_set_STORM.setText(_translate("Dialog_Imagereg", "Set", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.dSTORM), _translate("Dialog_Imagereg", "dSTORM", None))
        self.label_6.setWhatsThis(_translate("Dialog_Imagereg", "<html><head/><body><p align=\"center\"><span style=\" font-weight:600; color:#aa0000;\">dSTORM configuration:</span></p></body></html>", None))
        ...
        self.pushButton_delete_SIM.setText(_translate("Dialog_Imagereg", "Delete", None))
        self.label_8.setText(_translate("Dialog_Imagereg", "marker number", None))
        self.label_7.setText(_translate("Dialog_Imagereg", "position X", None))
        self.label_9.setText(_translate("Dialog_Imagereg", "position Y", None))
        self.pushButton_set_SIM.setText(_translate("Dialog_Imagereg", "Set", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.SIM), _translate("Dialog_Imagereg", "SIM", None))
        self.label_info_registration.setText(_translate("Dialog_Imagereg", "<html><head/><body><p align=\"center\"><span style=\" font-size:10pt; font-weight:600; color:#ffffff;\">-</span></p></body></html>", None))
        self.comboBox_registration_mode.setItemText(0, _translate("Dialog_Imagereg", "bUnwarpJ (slow)", None))
        self.comboBox_registration_mode.setItemText(1, _translate("Dialog_Imagereg", "Affine (fast)", None))
