...
"}")
    ...
    def retranslateUi(self, Dialog_Roi):
        Dialog_Roi.setWindowTitle(_translate("Dialog_Roi", "Dialog", None))
        self.label.setText(_translate("Dialog_Roi", "<html><head/><body><p align=\"center\"><span style=\" font-size:16pt; font-weight:600; color:#ffaa00;\">Roi</span></p></body></html>", None))
        self.push_buttom_correlate.setText(_translate("Dialog_Roi", "correlate", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.dSTORM), _translate("Dialog_Roi", "dSTORM", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.SIM), _translate("Dialog_Roi", "SIM", None))
        self.label_info_registration.setText(_translate("Dialog_Roi", "<html><head/><body><p align=\"center\"><span style=\" font-size:10pt; font-weight:600; color:#ffffff;\">-</span></p></body></html>", None))
        self.comboBox_registration_mode.setItemText(0, _translate("Dialog_Roi", "Pearson", None))
