...
"}")
    ...
    def retranslateUi(self, Dialog_imageregistration):
        ...
        Dialog_imageregistration.setWindowTitle(_translate("Dialog_imageregistration", "Image registration tool"))
        self.groupBox_3.setTitle(_translate("Dialog_imageregistration", "STORM channel"))
        self.groupBox_2.setTitle(_translate("Dialog_imageregistration", "Confocal channel"))
        self.pushButton_delete_markers.setText(_translate("Dialog_imageregistration", "Delete markers"))
        self.pushButton_manual_selection.setText(_translate("Dialog_imageregistration", "Manual selection"))
        self.pushButton_automatic_selection.setText(_translate("Dialog_imageregistration", "Automatic selection"))
        self.pushButton_Registration.setText(_translate("Dialog_imageregistration", "Registration"))
