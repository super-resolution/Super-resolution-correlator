...
#==============================================================================
    ...
    for i in range(num_iters):
        ...
        if area == numpy.sum(msnake.levelset, axis=None):
            # print i
            #print area
            break
        else:
            area = numpy.sum(msnake.levelset, axis=None)
            #print area

        # Update figure.
        ##del ax1.collections[0]
        ##ax1.contour(msnake.levelset, [0.5], colors='y')
        ##ax1.set_axis_off()

# if export needed for animation
#==============================================================================
        #filename=str(i)+".png"
        #fig.savefig(filename, dpi=600, facecolor='k', edgecolor='k',
...
#==============================================================================
    ...
    ##figg=ppl.figure(facecolor=(0, 0, 0), edgecolor=(0, 0, 0))
    ##axes = figg.add_subplot(111, axisbg='k')
    
    ##ax_u = axes.imshow(msnake.levelset)
